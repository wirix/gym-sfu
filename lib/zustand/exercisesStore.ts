...
export const useExercisesStore = create<ExercisesStore>()(
  persist(
      ...
      exercises: [
        {
          ...
          description:
            'Упражнение для развития мышц ног и ягодиц. Основное движение в пауэрлифтинге.',
        },
        {
          id: '1',
    ...
    {
      name: 'exercises-storage', // уникальное имя для localStorage
      storage: createJSONStorage(() => localStorage), // или sessionStorage
    },
  ),
);